...
public class MainActivity {
    ...
    public void setGlobals(String sID) {
        MainRecommender.globalClass.setHandler(this.databaseHandler);
        MainRecommender.globalClass.setAllShops(this.databaseHandler.getAllShops());
        MainRecommender.globalClass.setUser(new User(this.databaseHandler.getAllShops(), sID));
    }
}
