...
public class RouteCalculationActivity {
    ...
    public void compositeOrder() {
        ...
        globalClass.setRightCompositeShopOrder(compositeShopOrder);
        mainRecommender.setGlobalClass(globalClass);
    }

    public int getShopSize() {
        return globalClass.getCompositeShopSize();
    }
    ...
    private ArrayList<Shop> determineCompositeRecommendedShops() {
        ...
        CompositeRecommender compositeRecommender = new CompositeRecommender(this.mainRecommender, handler, new ArrayList<Shop>(allShops), handler.getShopTable().getShopSimilarities(), currentUser);
        double gamma = 1.0;
