...
public class RecommendationActivity {
    ...
    public void contentBasedOrder() {
        ...
        globalClass.setRightHybridShopOrder(hybridShopOrder);
        this.mainRecommender.setGlobalClass(globalClass);
    }
    ...
    private ArrayList<Shop> getRandomShops(int shopSize) {
        ...
        ArrayList<Shop> allShops = globalClass.getAllShops();
    ...
    private void addCompositeShops() {
        this.posFeedback = new ArrayList();
        this.negFeedback = new ArrayList();
        ArrayList<Shop> compositeShopOrder = globalClass.getRightCompositeShopOrder();
    ...
    public void addContentbasedShops() {
        ...
        this.negFeedback = new ArrayList();
        System.out.println("Composite Shop Size: " + this.shopSize);
        ArrayList<Shop> contentbasedShopOrder = globalClass.getRightHybridShopOrder();
    ...
    public String getHTML(String position) {
        ...
        this.routeTime = (int)new Path(this.mainRecommender, this.recommendedShops, globalClass.getAllShops()).getTotalPathDistance() + shopTime;
        String shopTable = "";
    ...
    public void confirmRecommendation() {
        ...
        globalClass.setUser(currentUser);
