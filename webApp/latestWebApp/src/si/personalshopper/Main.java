...
public class Main {
    ...
    public void startMain() {
        ...
        for (Shop shop : compositeRecommender.getGlobalClass().getAllShops()) {
            this.allShopNames.add(shop.getName());
        }
        for (Shop shop : contentbasedRecommender.getGlobalClass().getAllShops()) {
            this.allShopNames.add(shop.getName());
        }
        for (Shop shop : randomRecommender.getGlobalClass().getAllShops()) {
            this.allShopNames.add(shop.getName());
        }
    }
    ...
    public void saveColdStartPrefRec(String userID, String persona, String recLeftName, String recRightName, String prefRecName) {
        String path = "/home/sviersel/feedbackData/feedbackColdStartPreferredRecSys.csv";
    ...
    public void saveColdStartPrefShops(String userID, String persona, String recName, String posFeedbackString) {
        String path = "/home/sviersel/feedbackData/feedbackColdStartPreferredShops.csv";
        BufferedWriter br = this.getFile(path);
        String newLine = "";
        newLine = newLine + userID + "^";
        newLine = newLine + persona + "^";
    ...
    public void saveIterationsPrefRec(String userID, String persona, String prefRecName) {
        String path = "/home/sviersel/feedbackData/feedbackIterationsPreferredRecSys.csv";
        BufferedWriter br = this.getFile(path);
        String newLine = "";
        newLine = newLine + userID + "^";
        newLine = newLine + persona + "^";
        newLine = newLine + this.firstRecommender + "^";
        newLine = newLine + this.getRouteLength(this.firstRecommender) + "^";
    ...
    public void saveIterationsPrefShops(String userID, String persona, String recName, String posFeedbackString) {
        String path = "/home/sviersel/feedbackData/feedbackIterationsPreferredShops.csv";
        BufferedWriter br = this.getFile(path);
        String newLine = "";
        newLine = newLine + userID + "^";
        newLine = newLine + persona + "^";
    ...
    public void saveFeedback(String userID, String feedbackString) {
        String path = "/home/sviersel/feedbackData/feedbackExperiment.csv";
        BufferedWriter br = this.getFile(path);
        String newLine = "";
        newLine = newLine + userID + "^";
        newLine = newLine + feedbackString + "^";
        newLine = newLine + this.getDate();
        try {
            br.newLine();
            br.append(newLine);
